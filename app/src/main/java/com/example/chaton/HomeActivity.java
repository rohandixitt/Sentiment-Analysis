...
import com.example.chaton.Fragments.ChatsFragment;
import com.example.chaton.Fragments.ProfileFragment;
import com.example.chaton.Fragments.UsersFragment;
import com.example.chaton.Model.User;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.chatbot:
                ...
                break;
            case R.id.analysis:
                startActivity(new Intent(HomeActivity.this, SentimentActivity.class));
                break;
